...
DEFAULT_COST_DATA_PATH = PROJECT_ROOT / "data" / "cost_required_ha.csv"
...
DEFAULT_COST_ESTIMATORS_CACHE_PATH = PROJECT_ROOT / "outputs" / "cost_estimators_cache_ha.joblib"
DEFAULT_COST_ESTIMATORS_MERGED_PATH = PROJECT_ROOT / "outputs" / "cost_estimators_merged_ha.csv"
...
DEFAULT_DISTANCE_PENALTY_WEIGHT = 150.0
